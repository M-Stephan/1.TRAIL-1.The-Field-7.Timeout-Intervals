...
export function spawnTaupe(time) {
    if (taupe) {
        taupe.style.backgroundImage = `url("https://github.com/ndc-studio/1.TRAIL-1.The-Field-7/assets/buis-one.png")`;
    ...
    taupe = randomTaupe;
    taupe.style.backgroundImage = `url("https://github.com/ndc-studio/1.TRAIL-1.The-Field-7/assets/taupe.png")`;
    taupe.style.backgroundSize = "contain";
    taupe.style.backgroundPosition = "center";
    taupe.style.backgroundRepeat = "no-repeat";
