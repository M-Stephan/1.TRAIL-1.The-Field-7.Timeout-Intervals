...
export function spawnTaupe(time) {
    if (taupe) {
        taupe.style.backgroundImage = `url("https://m-stephan.github.io/1.TRAIL-1.The-Field-7.Timeout-Intervals/assets/buis-one.png")`;
    ...
    taupe = randomTaupe;
    taupe.style.backgroundImage = `url("https://m-stephan.github.io/1.TRAIL-1.The-Field-7.Timeout-Intervals/assets/taupe.png")`;
    taupe.style.backgroundSize = "contain";
    taupe.style.backgroundPosition = "center";
    taupe.style.backgroundRepeat = "no-repeat";
